...
htmlhelp_basename = 'Pymdsetupdoc'
...
latex_documents = [
    (master_doc, 'Pymdsetup.tex', u'Pymdsetup Documentation',
...
man_pages = [
    (master_doc, 'pymdsetup', u'Pymdsetup Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Pymdsetup', u'Pymdsetup Documentation',
     author, 'Pymdsetup', 'One line description of project.',
     'Miscellaneous'),
]
